...
class DecoratorCardWithDistance extends StatelessWidget {
  final User store;
  final bool fromAllStore;
  final bool? isNewStore;
  const DecoratorCardWithDistance(
      {super.key,
      required this.store,
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      children: [
        GetBuilder<DetailsController>(builder: (detailsController) {
          return Container(
            ...
            child: CustomInkWell(
              onTap: () async {
                ...
                detailsController.clearMediaModel();
                await detailsController.getDetails(true, store.id!);
                Get.toNamed(RouteHelper.getDetailsRoute());
                // Get.toNamed(RouteHelper.getDetailsRoute());
              },
                        ...
                        child: Row(
                            ...
                            children: [
                              ...
                              CustomButton(
                                ...
                                onPressed: () {
                                  openGoogleMaps(store.address!); // Redirect to Google Maps with the store's address
                                },
                                buttonText: 'visit'.tr,
                                color: Theme.of(context).primaryColor,
