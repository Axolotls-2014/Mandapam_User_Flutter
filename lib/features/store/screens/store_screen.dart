    ...
    return Scaffold(
      ...
      body: GetBuilder<StoreController>(builder: (storeController) {
        return GetBuilder<CategoryController>(builder: (categoryController) {
          ...
          // log("storeController.categoryList!.isNotEmpty:::${storeController.categoryList!.isNotEmpty}");
      ...
      floatingActionButton:
        ...
        log("visible: storeController.showFavButton:::${storeController.showFavButton && Get.find<SplashController>().configModel!.moduleConfig!.module!.orderAttachment! && (storeController.store != null && storeController.store!.prescriptionOrder!) && Get.find<SplashController>().configModel!.prescriptionStatus! && AuthHelper.isLoggedIn()}");
        return Visibility(
