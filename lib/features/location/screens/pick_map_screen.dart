...
class _PickMapScreenState extends State<PickMapScreen> {
                    ...
                    child: CustomButton(
                      ...
                      onPressed: locationController.isLoading
                          ...
                          : (locationController.buttonDisabled ||
                              ...
                              ? null
                              : () {
                                  log("locationController.buttonDisabled || locationController.loading::${locationController.buttonDisabled || locationController.loading}");
                                  _onPickAddressButtonPressed(
                                      locationController);
                                },
                    ),
  ...
  void _onPickAddressButtonPressed(LocationController locationController) {
    log("In onPickAddressButtonPressed");
    if (locationController.pickPosition.latitude != 0 &&
        locationController.pickAddress!.isNotEmpty) {
      log("In if condition ::onPickAddressButtonPressed");
      log("In widget.onPicked:::${widget.onPicked}");
      log("In widget.fromAddAddress:::${widget.fromAddAddress}");
      if (widget.onPicked != null) {
        ...
        log("widget.fromLandingPage:::${widget.fromLandingPage}");
        if (widget.fromLandingPage) {
