...
class _FlashSaleViewWidgetState extends State<FlashSaleViewWidget> {
  ...
  Widget build(BuildContext context) {
    log("In FlashSaleViewWidget:::build");
    return GetBuilder<FlashSaleController>(builder: (flashSaleController) {
      ...
      log("flashSaleController.flashSaleModel != null:::${flashSaleController.flashSaleModel != null}");
      // log("flashSaleController.flashSaleModel!.activeProducts != null &&flashSaleController.duration!.inSeconds > 1:::${flashSaleController.flashSaleModel!.activeProducts != null && flashSaleController.duration!.inSeconds > 1}");
...
class FlashSaleShimmerView extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    log("In FlashSaleShimmerView::build");
    return Container(
      width: Get.width,
