                          ...
                          ? catController.categoryList!.isNotEmpty
                              ? GridView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    return InkWell(
                                      onTap: () {
                                        // log("catController.categoryList![index].id${catController.categoryList![index].id}");
                                        // log("catController.categoryList![index].title!${catController.categoryList![index].title!}");
                                        // Get.toNamed(
