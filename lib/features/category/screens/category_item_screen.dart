...
import 'package:sixam_mart/features/nearby/widgets/decorator_view.dart';
...
class CategoryItemScreenState extends State<CategoryItemScreen>
  ...
  Widget build(BuildContext context) {
    return GetBuilder<DecoratorController>(builder: (decoratorController) {
                  ...
                  child: TabBarView(
                    ...
                    children: [
                      ...
                      SingleChildScrollView(
                          controller: storeScrollController,
                          child:
                              (decoratorController.eventDecoratorModel != null)
                                  ? DecoratorView(
                                      isStore: true,
                                      items: null,
                                      stores: (decoratorController
                                                  .eventDecoratorModel !=
                                              null)
                                          ? decoratorController
                                              .eventDecoratorModel!.users
                                          : null,
                                      noDataText: Get.find<SplashController>()
                                              .configModel!
                                              .moduleConfig!
                      ...
                      // SingleChildScrollView(
                      //   controller: storeScrollController,
                      //   child: (decoratorController.eventDecoratorModel != null)
                      //       ? ViewMediaScreen(
                      //     selectedEventId: decoratorController.eventDecoratorModel!.selectedEventId,
                      //   )
                      //       : const SizedBox(),
                      // ),
