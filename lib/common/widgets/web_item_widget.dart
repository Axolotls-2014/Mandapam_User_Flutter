                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CustomImage(
                                ...
                                height: desktop ? 140 : length == null ? 100 : 65,
                                width: desktop ? isStore ? 275 : 300 : 80,
                                fit: BoxFit.cover,
                              ),
                            ),
                            DiscountTag(
                                ...
                                children: [
                                  ...
                                  (genericName.isNotEmpty)
                                    ...
                                    child: Text(
                                      ...
                                      : const SizedBox(),
                                  (isStore ? store!.address != null : item!.title != null)
                                      ? Text(
                                    isStore ? store!.address ?? '' : item!.title ?? '',
                                    style: robotoRegular.copyWith(
                                    ...
                                    overflow: TextOverflow.ellipsis,
                                      ...
                                      : const SizedBox(),
                                  SizedBox(height: ((desktop || isStore) && (isStore ? store!.address != null : item!.title != null)) ? 5 : 0),
                                  // isStore ? RatingBar(
                                  //   rating: isStore ? store!.avgRating : item!.popular, size: desktop ? 15 : 12,
